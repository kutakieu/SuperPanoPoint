...
from superpanopoint.lossfn_optimizer import (descriptor_loss,
...
class LightningWrapper(pl.LightningModule):
    def __init__(self, cfg) -> None:
        ...
        self.lossfn_descriptor = descriptor_loss
    ...
    def _clac_description_loss(self, desc: Tensor, warped_desc: Tensor, correspondence_mask: Tensor):
        return descriptor_loss(desc, warped_desc, correspondence_mask)
